<nav id="mainNav" class="navbar fixed-top navbar-default navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="../index.php">जीवनदान - Gift a Life</a>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <ul class="navbar-nav form-inline my-2 my-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../alllogs.php">All Logs</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../addcontacts.php">Add Life Saving Contacts</a>
      </li>
      <!-- <li class="nav-item">
